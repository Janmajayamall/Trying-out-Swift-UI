//
//  ProfileChangeUsernameView.swift
//  Trial
//
...
struct ProfileChangeUsernameView: View {
    ...
    var body: some View {
        ...
        .cornerRadius(15)
        .offset(CGSize(width: .zero, height: self.screenManagement.activeProfileScreenOverlay == .changeUsername ? 0 : self.parentSize.height))
        .animation(.spring())
    }
...
//struct ProfileChangeUsernameView_Previews: PreviewProvider {
