...
struct ColorPickerSlider: View {
    ...
    @State var selectedYCoord: CGFloat {
        didSet{
            self.currentCanvas.painting.changeSelectedColor(to: Color(UIColor(hue: self.selectedYCoord/ColorPickerSlider.colorPickerHeight,saturation: 1, brightness: 1, alpha: 1) ), withYCoord: self.selectedYCoord)
...
//{
//    didSet{
//        self.selectedColor = self.colorFromCoords(currentY: self.selectedYCoord)
//    }
//}
