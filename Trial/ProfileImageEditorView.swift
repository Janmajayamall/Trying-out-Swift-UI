//
//  ProfileImageEditorViewView.swift
//  Trial
//
...
struct ProfileImageEditorView: View {
    ...
    func cropProfileImage(){
        ...
        if let cropImage = croppedImage {
            self.croppedImage = UIImage(cgImage: cropImage)
        }
    }
...
//struct ProfileImageEditorView_Previews: PreviewProvider {
//    static var previews: some View {
//        ProfileImageEditorViewView()
//    }
//}
//
