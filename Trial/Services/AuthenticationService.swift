...
//protocol AuthenticationServiceDelgate: class {
//    func authenticationService(didChangeUser user: User)
//    func authenticationService(didUserSignedOutWithValue value: Bool)
//}
//
//extension AuthenticationServiceDelgate {
//    func authenticationService(didChangeUser user: User) {}
//    func authenticationService(didUserSignedOutWithValue value: Bool) {}
//}
...
class AuthenticationService {
    ...
    func registerStateListener(){
        ...
        self.handle = Auth.auth().addStateDidChangeListener({(auth, user) in
            print("This is the user: \(user?.displayName!)")
            print("This is the auth for user: \(auth)")
            if let user = user {
                
                self.user = user
                NotificationCenter.default.post(name: .didAuthStatusChange, object: user)
            }
        })
    }
...
//            self.delegate?.authenticationService(didUserSignedOutWithValue: true)
        }catch {
